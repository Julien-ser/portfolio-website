# Iteration 22 - portfolio-website

**Timestamp:** Thu Mar 12 11:13:48 AM EDT 2026
...
[0m
I'll add LinkedIn API integration to fetch profile data for the `about` process. Let me start by exploring the project structure and then implementing the required changes.
[0m→ [0mRead package.json
[0m→ [0mRead TASKS.md
[0m
[0m$ [0mfind . -type f -name "*.ts" -o -name "*.tsx" -o -name "*.json" | grep -E "(lib|components|data)" | head -20
./lib/windows/processRegistry.tsx
./lib/windows/WindowManager.tsx
./lib/api/duckduckgo.ts
./lib/terminal/trie.ts
./lib/terminal/history.ts
./lib/terminal/parser.ts
./lib/terminal/sh-handler.ts
./lib/chatbot/chatbot.ts
./data/projects.ts
./data/interview.json
./components/windows/ProcessWindow.tsx
./components/windows/WindowRenderer.tsx
./components/processes/Resume.tsx
./components/processes/index.ts
./components/processes/About.tsx
./components/processes/Projects.tsx
./components/processes/Contact.tsx
...
[0m✱ [0mGlob "app/**/*.tsx"[90m 2 matches[0m
```
...
**Completed at:** Thu Mar 12 11:14:10 AM EDT 2026
